...
public struct Multipart: Sendable {
    ...
    mutating func append(fileString: String, withName name: String) {
    ...
    mutating func append(fileData: Data, withName name: String, fileName: String?, mimeType: CoreHTTPMimeType?) {
        data.append(topBoundry)
        data.append(separator)
    ...
    mutating func append(fileURL: URL, withName name: String) {
